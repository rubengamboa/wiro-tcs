...
/* Weger   Nov. 9, 2000:   FOCUS_CMD and FOCUS_RATE inserted. */
...
/* #define FOCUS_STATUS	tinfo->focus_status */
#define FOCUS_CMD   	tinfo->focus_cmd
#define FOCUS_RATE  	tinfo->focus_rate
...
struct wiro_memory {
   ...
   int
      /* focus_status          Remote-focusing flag & remote-read/write flag */
      focus_cmd,            /* Remote-in, remote-out, or remote-hold */
      focus_rate;           /* Remote-fast or remote-slow */
